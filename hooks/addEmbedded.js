...
module.exports = function (context) {
    ...
    console.log('[WannadsPlugin] hook - addEmbedded.js');

    function fromDir(startPath, filter, rec, multiple) {
        if (!fs.existsSync(startPath)) {
            console.log('[WannadsPlugin] ERROR - no dir', startPath);
            return;
        }
    ...
    var buildPhaseObj = myProj.buildPhaseObject('PBXCopyFilesBuildPhase', groupName, myProj.getFirstTarget().uuid);
    if (buildPhaseObj != null) {
        console.log('[WannadsPlugin] build phase already added');
        return;
    }

    console.log('[WannadsPlugin] adding Build Phase to project...');
    ...
    console.log('[WannadsPlugin] framework files added succesfully');
};